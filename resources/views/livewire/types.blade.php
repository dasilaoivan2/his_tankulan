...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.types.edit')
            @include('livewire.types.confirmsave')
            @include('livewire.types.confirmupdate')
            @include('livewire.types.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border">
                                <x-jet-button class="m-2" wire:click="edit({{$type->id}})">
                                    {{ __('Edit') }}
                                </x-jet-button>

                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$type->id}})">
                                    {{ __('Delete') }}
