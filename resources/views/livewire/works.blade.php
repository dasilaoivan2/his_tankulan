...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.works.create')
            @include('livewire.works.edit')
            @include('livewire.works.confirmsave')
            @include('livewire.works.confirmupdate')
            @include('livewire.works.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border">
                                <x-jet-button class="m-2" wire:click="edit({{$work->id}})">
                                    {{ __('Edit') }}
                                </x-jet-button>

                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$work->id}})">
                                    {{ __('Delete') }}
