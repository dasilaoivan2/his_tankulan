...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.materials.create')
            @include('livewire.materials.edit')
            @include('livewire.materials.confirmsave')
            @include('livewire.materials.confirmupdate')
            @include('livewire.materials.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border">
                                <x-jet-button class="m-2" wire:click="edit({{$material->id}})">
                                    {{ __('Edit') }}
                                </x-jet-button>

                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$material->id}})">
                                    {{ __('Delete') }}
