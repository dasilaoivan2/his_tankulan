<x-jet-dialog-modal maxWidth="2xl" wire:model="editZoneBrgy">
                ...
                <div class="px-2 py-2 bg-white sm:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                        <div class="mb-2">
                            ...
                            <select id="barangay_id" wire:model="barangay_id" wire:click.prevent="checkBarangay()" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" disabled>
    ...
    <x-slot name="footer">
        <div class="">
            ...
            <x-jet-button wire:click="updateZoneBrgy()">
                {{ __('UPDATE') }}
            </x-jet-button>
