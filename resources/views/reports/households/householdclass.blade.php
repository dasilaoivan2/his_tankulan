...
<div id="logo-bg">
    ...
    <div class="header">
        ...
        <table>
            <tr>
                <td style="font-size: 16pt; font-weight: bold">HOUSEHOLD CLASSIFICATION REPORT</td>
            </tr>
            <tr>
                <td style="font-size: 14pt; font-weight: bold; text-transform:uppercase">{{$classification->name}}</td>
            </tr>
        </table>
    </div>
