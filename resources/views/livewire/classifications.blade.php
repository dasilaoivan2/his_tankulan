...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.classifications.create')
            @include('livewire.classifications.edit')
            @include('livewire.classifications.confirmsave')
            @include('livewire.classifications.confirmupdate')
            @include('livewire.classifications.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $classification->id}}</td>
                            ...
                            <td class="border">
                                ...
                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$classification->id}})">
                                    {{ __('Delete') }}
