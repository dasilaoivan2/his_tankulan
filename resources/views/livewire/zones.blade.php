...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.zones.confirmsave')
            @include('livewire.zones.confirmupdate')
            @include('livewire.zones.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $zone->barangay->name }}</td>
                            <td class="border">
                                <x-jet-button class="m-2" wire:click="edit({{$zone->id}})">
                                    {{ __('Edit') }}
                                </x-jet-button>

                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$zone->id}})">
                                    {{ __('Delete') }}
