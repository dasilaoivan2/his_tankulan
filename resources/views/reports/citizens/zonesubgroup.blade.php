...
<body class="long-size">
    ...
    <div class="header">
        ...
        <table>
            <tr>
                <td style="font-size: 16pt; font-weight: bold">{{$group_name}} REPORT BY ZONE</td>
            </tr>
            <tr>
                <td style="font-size: 14pt; font-weight: bold; text-transform:uppercase">{{$zone->name}}</td>
            </tr>
            <tr>
                <td style="font-size: 12pt; font-weight: bold; text-transform:uppercase">{{$subgroup_name}}</td>
            </tr>
        </table>
    </div>
