                    ...
                    <x-jet-dropdown align="right" width="40">
                        ...
                        <x-slot name="content">
                            <div class="w-40 text-left font-bold">
                                <x-jet-dropdown-link href="{{ route('classifications') }}" :active="request()->routeIs('classifications')">
                                    {{ __('Classifications') }}
                                </x-jet-dropdown-link>

                                <x-jet-dropdown-link href="{{route('types')}}" :active="request()->routeIs('types')">
                                    {{ __('Types') }}
                                </x-jet-dropdown-link>
                                ...
                                <x-jet-dropdown-link href="{{route('programs')}}" :active="request()->routeIs('programs')">
                                    {{ __('Programs') }}
                                </x-jet-dropdown-link>
                    ...
                    <x-jet-dropdown align="right" width="40">
                        ...
                        <x-slot name="content">
                            <div class="block px-4 py-2 text-xs text-gray-400">
                                ...
                                <div class="w-40 text-left font-bold">
                                    <x-jet-dropdown-link href="{{ route('citizenreports') }}" :active="request()->routeIs('citizenreports')">
                                        {{ __('All Citizens') }}
                                    </x-jet-dropdown-link>

                                    <x-jet-dropdown-link href="{{ route('citizenzonereports') }}" :active="request()->routeIs('citizenzonereports')">
                                        {{ __('Zone') }}
                                    </x-jet-dropdown-link>
                            ...
                            <div class="block px-4 py-2 text-xs text-gray-400">
                                ...
                                <div class="w-40 text-left font-bold">
                                    <x-jet-dropdown-link href="{{ route('householdreports') }}" :active="request()->routeIs('householdreports')">
                                        {{ __('All Households') }}
                                    </x-jet-dropdown-link>

                                    <x-jet-dropdown-link href="{{route('householdtypereports')}}" :active="request()->routeIs('householdtypereports')">
                                        {{ __('Types') }}
                                    </x-jet-dropdown-link>

                                    <x-jet-dropdown-link href="{{route('householdclassreports')}}" :active="request()->routeIs('householdclassreports')">
                                        {{ __('Classification') }}
                                    </x-jet-dropdown-link>

                                    <x-jet-dropdown-link href="{{route('householdzonereports')}}" :active="request()->routeIs('householdzonereports')">
                                        {{ __('Zone') }}
                                    </x-jet-dropdown-link>
