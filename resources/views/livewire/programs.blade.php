...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.programs.create')
            @include('livewire.programs.edit')
            @include('livewire.programs.confirmsave')
            @include('livewire.programs.confirmupdate')
            @include('livewire.programs.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border">
                                <x-jet-button class="m-2" wire:click="edit({{$program->id}})">
                                    {{ __('Edit') }}
                                </x-jet-button>

                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$program->id}})">
                                    {{ __('Delete') }}
