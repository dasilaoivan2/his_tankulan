...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @include('livewire.familyroles.create')
            @include('livewire.familyroles.edit')
            @include('livewire.familyroles.confirmsave')
            @include('livewire.familyroles.confirmupdate')
            @include('livewire.familyroles.confirmdelete')
                ...
                <table class="table-auto w-full text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $familyrole->id}}</td>
                            <td class="border px-4 py-2">{{ $familyrole->name }}</td>
                            <td class="border">
                                <x-jet-button class="m-2" wire:click="edit({{$familyrole->id}})">
                                    {{ __('Edit') }}
                                </x-jet-button>

                                <x-jet-secondary-button class="m-2" wire:click="confirmDelete({{$familyrole->id}})">
                                    {{ __('Delete') }}
